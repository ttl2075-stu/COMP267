...
int main () {
    ...
    ifstream fileIn;
    ofstream fileOut;
    fileIn.open("diemthi_02.inp");
    fileOut.open("diemthi_02.out");
    ...
    // In ra 3 TP co muc chenh lech nho nhat
    for (int i = 0; i < 3; i++) {
        // arr[n-1-i] lay tu cuoi danh danh (cuoi cua ds giam dan la nho nhat)
